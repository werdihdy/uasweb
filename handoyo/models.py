...
class Kategori(models.Model):
    ...
    banner_dua = models.ImageField(upload_to='gambar/banner', blank=True, null=True, verbose_name="Gambar (270 x 250 pixel)")
    ...
    # def __str__(self):
    #     return '%s, %s' % (self.nama, self.slug)
    def __str__(self):
...
class Produk(models.Model):
    ...
    gambar = models.ImageField(upload_to='gambar/banner', blank=False, null=True)
    ...
    gambar_lima= models.ImageField(upload_to='gambar/banner', blank=True, null=True)
