...
from werdicart.models import Transaksi, DetailTransaksi
...
from werdicart.forms import CartAddProductForm
from werdicart.keranjang import Cart
import datetime
...
class CheckoutView(View):
    ...
    def post(self, request):
        ...
        return render(request, 'checkout.html', context, status=400)
# def single_produk(request, id):
#     produk = get_object_or_404(Produk, id=id)
#     context = {
#         "judul":"Single Produk",
#         "single_produk": produk,
#     }
#     return render(request, 'singleproduk.html', context)