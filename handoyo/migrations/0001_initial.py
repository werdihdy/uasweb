    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner_dua', models.ImageField(blank=True, null=True, upload_to='gambar/banner', verbose_name='Gambar (270 x 250 pixel)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gambar_satu', models.ImageField(blank=True, null=True, upload_to='gambar/banner')),
                ...
                ('kategori', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='produks', to='handoyo.kategori')),
            ],
            options={
